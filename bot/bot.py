...
# TOKEN = "7053354152:AAFtHtcZEJA4Lw_u7hglZeVver_-jnxUKvM"
...
def get_repl_logs(update: Update, context):
    ...
    result = execute_command(ssh, 'docker logs db_image | grep replication')
    ssh.close()
...
def insert_phone_numbers(phone_numbers):
    try:
        ...
        for number in phone_numbers:
            cursor.execute("INSERT INTO PhoneNumbers (phonenumbers) VALUES (%s)", (number,))
        connection.commit()
